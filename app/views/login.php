    ...
    <section
        ...
        <div class="col col-md-8 col-lg-6 col-xxl-5">
            ...
            <div class="shadow-xl p-4 p-lg-5 bg-white">
                ...
                <form>
                    ...
                    <div class="form-group">
                      <label for="login-password" class="form-label d-flex justify-content-between align-items-center">
                        Contraseña
                        <a href="./forgotten-password.php" class="text-muted small">¿Olvidaste tu contraseña?</a>
                      </label>
                ...
                <p class="d-block text-center text-muted">¿Eres nuevo cliente? <a class="text-muted" href="./register.php">Regístrate para obtener una cuenta</a></p>
            </div>
