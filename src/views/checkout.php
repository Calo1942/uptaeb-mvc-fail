                        ...
                        <nav class="d-none d-md-block">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                ...
                                <div class="form-group form-check m-0">
                                  ...
                                  <label class="form-check-label small text-muted" for="add-mailinglist">Mantenme actualizado con tus últimas noticias y ofertas</label>
                                </div>
                              </div>
                            </div>
                            
                            <h3 class="fs-5 mt-5 fw-bolder mb-4 border-bottom pb-4">Dirección de Envío</h3>
                            <div class="row">
                              <!-- First Name-->
                              <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="pt-4 mt-4 pb-5 border-top d-flex justify-content-between align-items-center">
                              ...
                              <div class="form-group form-check m-0">
                                ...
                                <label class="form-check-label" for="same-address">Usar para la dirección de facturación</label>
                              </div>
                            </div>
                            
                            <!-- Billing Address-->
                            <div class="billing-address d-none">
                              <h3 class="fs-5 fw-bolder mb-4 border-bottom pb-4">Dirección de Facturación</h3>
                              <div class="row">
                                <!-- First Name-->
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="firstNameAddress" class="form-label">Nombre</label>
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="lastNameAddress" class="form-label">Apellido</label>
                                ...
                                <div class="col-12">
                                  <div class="form-group">
                                    <label for="addressAddress" class="form-label">Dirección</label>
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <label for="countryAddress" class="form-label">País</label>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="zipAddress" class="form-label">Código Postal</label>
                    ...
                    <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
                        ...
                        <div class="py-4">
                            <div class="input-group mb-0">
                                <input type="text" class="form-control" placeholder="Introduce tu código de cupón">
