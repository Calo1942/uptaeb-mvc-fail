                    ...
                    <div class="pe-lg-5">
                        ...
                        <nav class="d-none d-md-block">
                            ...
                            <ul class="list-group mb-5 d-none d-lg-block rounded-0">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div class="d-flex justify-content-start align-items-center">
                                        <span class="text-muted small me-2 f-w-36 fw-bolder">Entregar A</span>
                                        <span class="small">123 Street, London, SM3 5TY, United Kingdom</span>
                                    </div>
                                    <a href="./?url=checkout_shipping" class="text-muted small" role="button">Cambiar</a>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div class="d-flex justify-content-start align-items-center">
                                        <span class="text-muted small me-2 f-w-36 fw-bolder">Método</span>
                                ...
                                <div class="form-check form-group form-check-custom form-radio-custom mb-3">
                                  ...
                                  <label class="form-check-label" for="checoutPaymentStripe">
                                    <span class="d-flex justify-content-between align-items-start">
                                      <span>
                                        <span class="mb-0 fw-bolder d-block">Tarjeta de Crédito (Stripe)</span>
                                      </span>
                                  ...
                                  <div class="form-group">
                                    <div class="d-flex">
                                      ...
                                      <button type="button" class="btn btn-link p-0 fw-bolder fs-xs text-nowrap" data-bs-toggle="tooltip"
                                              ...
                                              title="Un CVV es un número en tu tarjeta de crédito o débito que está además de tu número de tarjeta de crédito y fecha de expiración">
                                        ¿Qué es esto?
                                      </button>
                                    </div>
                            ...
                            <div class="paypal-details bg-light p-4 d-none my-3 fw-bolder">
                              Por favor haz clic en completar pedido. Luego serás transferido a Paypal para ingresar tus detalles de pago.
                            </div>
                            <!-- /Paypal Info-->
                            ...
                            <div class="form-group form-check m-0">
                              ...
                              <label class="form-check-label fw-bolder" for="accept-terms">Estoy de acuerdo con los <a href="#">términos y condiciones</a> de Bruz Deporte</label>
                            </div>
                            
                            <div class="pt-5 mt-5 pb-5 border-top d-flex flex-column flex-md-row justify-content-between align-items-center">
                              <a href="./?url=checkout_shipping" class="btn ps-md-0 btn-link fw-bolder w-100 w-md-auto mb-2 mb-md-0" role="button">Volver al envío</a>
                              <a href="#" class="btn btn-dark w-100 w-md-auto" role="button">Completar Pedido</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="py-4 border-bottom">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <span class="text-muted small">Incluye $45.89 impuestos de venta</span>
                                </div>
