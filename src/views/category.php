...
<body class="">
    ...
    <section class="mt-0 ">
        ...
        <div class="py-10 bg-img-cover bg-overlay-dark position-relative overflow-hidden bg-pos-center-center rounded-0"
            ...
            <div class="container-fluid position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
                <h1 class="fw-bold display-6 mb-4 text-white">Últimas Llegadas</h1>
                <div class="col-12 col-md-6">
                    <p class="text-white mb-0 fs-5">
                        Cuando sea el momento de salir y ponerte tus zapatillas, echa un vistazo a nuestras últimas llegadas. Ya sea que te gusten Nike, Adidas, Dunks o New Balance, ¡realmente tenemos algo para todos!
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid" data-aos="fade-in">
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Nuevos Lanzamientos</li>
                            </ol>
                        </nav>        <h1 class="fw-bold fs-3 mb-2">Nuevos Lanzamientos (121)</h1>
                        <p class="m-0 text-muted small">Mostrando 1 - 9 de 121</p>
                    </div>
                    <div class="d-flex justify-content-end align-items-center mt-4 mt-lg-0 flex-column flex-md-row">
                        ...
                        <!-- Sort Options-->
                            <select class="form-select form-select-sm border-0 bg-light p-3 pe-5 lh-1 fs-7">
                                ...
                                <option value="1">Alto a Bajo</option>
                                <option value="2">Bajo a Alto</option>
                            ...
                            <div class="card-img position-relative">
                                ...
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    ...
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Añadir Rápido</button>
                                    </div>
                            </div>
            ...
            <div class="d-flex flex-column f-w-44 mx-auto my-5 text-center">
                <small class="text-muted">Mostrando 9 de 121 productos</small>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasFilters" aria-labelledby="offcanvasFiltersLabel">
      <div class="offcanvas-header pb-0 d-flex align-items-center">
        <h5 class="offcanvas-title" id="offcanvasFiltersLabel">Filtros de Categoría</h5>
      ...
      <div class="offcanvas-body">
        <div class="d-flex flex-column justify-content-between w-100 h-100">
          ...
          <div class="border-top pt-3">
            <a href="#" class="btn btn-dark mt-2 d-block hover-lift-sm hover-boxshadow" data-bs-dismiss="offcanvas" aria-label="Close">Hecho</a>
          </div>
          <!-- /Filter Button-->
        </div>
      </div>
